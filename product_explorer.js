...
// Create empty table initially - it will be populated when product is selected
    ...
    emptyCell.innerHTML = '<div>Select a product from the left panel to view its performance data</div>';
    emptyRow.appendChild(emptyCell);
    tbody.appendChild(emptyRow);

    // Add table to container
    container.querySelector("#productExplorerTableContainer").appendChild(table);
    console.log("[renderProductExplorerTable] Empty table created, waiting for product selection");
