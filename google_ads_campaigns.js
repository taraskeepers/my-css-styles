...
// Update efficiency metrics (this now handles both efficiency score and performance indicator)
...
// Calculate efficiency metrics according to the strategy
function calculateEfficiencyMetrics(bucketStats) {
  ...
  const campaignMetrics = calculateCampaignLevelMetrics(productMetrics, searchMetrics);
...
function calculateCampaignLevelMetrics(productMetrics, searchMetrics) {
