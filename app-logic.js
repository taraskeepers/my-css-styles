...
async function onReceivedRowsWithData(rows, companyStats, marketTrends, productTitlesEvaluated, productTitlesCompanies, companyPricing = null, companyImages = null) {
  ...
  console.log("CompanyPricing:", companyPricing?.length || 0, "records (optional)");
  console.log("CompanyImages:", companyImages?.length || 0, "records (optional)");
...
if (typeof processTableData === 'function') {
  ...
  // Only process optional tables if they exist
  if (companyPricing) {
...
// Process and use the loaded data (product tables can be empty, pricing and images are optional)
